...
# 				print(對照表格式.format(原本假名,標準音標,一筆[2]))
	...
	假名對照={
		...
		'バンバ－/バンパ－':'⿰バン⿰バ－/⿰バン⿰パ－', #1ban2-1ba3，保險桿
		...
		'ハイカラ/ハイ－カラ':'⿰ハイカラ/⿰ハ⿰イ－カラ', #1hai1-1kat8-1la2，西裝頭
		...
		'コンクリ－ト':'⿰コンク⿰リ－ト', #1khong3-1ku7-1li2，混凝土、控固力
		...
		'のうしんとう':'⿰のう⿰しん⿰とう', #1noo5-1sin2，腦筋不正常
