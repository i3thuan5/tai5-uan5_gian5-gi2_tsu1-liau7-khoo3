...
from 臺灣言語資料庫校對.批次介面 import 共大寫揣無字的當作外來詞
from 臺灣言語資料庫校對.人工校對介面 import 有問題愛改
...
urlpatterns = patterns('',
	...
	url(r'^有問題愛改$', 有問題愛改.as_view(), name='有問題愛改'),
	...
	url(r'^共大寫揣無字的當作外來詞$', 共大寫揣無字的當作外來詞, name='共大寫揣無字的當作外來詞'),
