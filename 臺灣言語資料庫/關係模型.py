...
class 翻譯影音表(models.Model):
	...
	影音 = models.ForeignKey(影音表, related_name = '來源外語', unique=True)

class 翻譯文本表(models.Model):
	外語 = models.ForeignKey(外語表, related_name = '翻譯文本')
	文本 = models.ForeignKey(文本表, related_name = '來源外語', unique=True)

class 影音文本表(models.Model):
	影音 = models.ForeignKey(影音表, related_name = '影音文本')
	文本 = models.ForeignKey(文本表, related_name = '來源影音', unique=True)
...
class 文本校對表(models.Model):
	...
	新文本 = models.ForeignKey(文本表, related_name = '來源校對資料', unique=True)
