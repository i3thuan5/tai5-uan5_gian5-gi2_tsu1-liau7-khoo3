...
class 揣來源試驗(TestCase):
	...
	def test_仝屬性共用(self):
		...
		self.assertEqual(來源表.揣來源({'名':'Dr. Pigu', '出世年':'1990', '出世地':'花蓮', }), Dr)
		self.assertEqual(來源表.揣來源({'名':'Mrs. Pigu', '出世年':'1990', '出世地':'吉安', }), Mrs)
	...
	def test_仝屬性揣無(self):
		...
		self.assertRaises(ObjectDoesNotExist,
			來源表.揣來源, {'名':'Mrs. Pigu', '出世年':'1990', '出世地':'吉安', })
	...
	def test_揣無來源袂使加來源資料(self):
		...
		self.assertRaises(ObjectDoesNotExist,
			來源表.揣來源, {'名':'Dr. Pigu', '出世年':'1990', '職業':'學生', })
